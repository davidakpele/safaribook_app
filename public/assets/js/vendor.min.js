 ...
 *
 */
(function (n, t, i, r) { var u = n(t); n.fn.lazyload = function (f) { function s() { var t = 0; o.each(function () { var i = n(this); if ((!e.skip_invisible || i.is(":visible")) && !n.abovethetop(this, e) && !n.leftofbegin(this, e)) if (n.belowthefold(this, e) || n.rightoffold(this, e)) { if (++t > e.failure_limit) return !1 } else i.trigger("appear"), t = 0 }) } var o = this, h, e = { threshold: 0, failure_limit: 0, event: "scroll", effect: "show", container: t, data_attribute: "original", skip_invisible: !1, appear: null, load: null, placeholder: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" }; return f && (r !== f.failurelimit && (f.failure_limit = f.failurelimit, delete f.failurelimit), r !== f.effectspeed && (f.effect_speed = f.effectspeed, delete f.effectspeed), n.extend(e, f)), h = e.container === r || e.container === t ? u : n(e.container), 0 === e.event.indexOf("scroll") && h.bind(e.event, function () { return s() }), this.each(function () { var i = this, t = n(i); i.loaded = !1; (t.attr("src") === r || t.attr("src") === !1) && t.is("img") && t.attr("src", e.placeholder); t.one("appear", function () { if (!this.loaded) { if (e.appear) { var r = o.length; e.appear.call(i, r, e) } n("<img />").bind("load", function () { var r = t.attr("data-" + e.data_attribute), u, f; t.hide(); t.is("img") ? t.attr("src", r) : t.css("background-image", "url('" + r + "')"); t[e.effect](e.effect_speed); i.loaded = !0; u = n.grep(o, function (n) { return !n.loaded }); o = n(u); e.load && (f = o.length, e.load.call(i, f, e)) }).attr("src", t.attr("data-" + e.data_attribute)) } }); 0 !== e.event.indexOf("scroll") && t.bind(e.event, function () { i.loaded || t.trigger("appear") }) }), u.bind("resize", function () { s() }), /(?:iphone|ipod|ipad).*os 5/gi.test(navigator.appVersion) && u.bind("pageshow", function (t) { t.originalEvent && t.originalEvent.persisted && o.each(function () { n(this).trigger("appear") }) }), n(i).ready(function () { s() }), this }; n.belowthefold = function (i, f) { var e; return e = f.container === r || f.container === t ? (t.innerHeight ? t.innerHeight : u.height()) + u.scrollTop() : n(f.container).offset().top + n(f.container).height(), e <= n(i).offset().top - f.threshold }; n.rightoffold = function (i, f) { var e; return e = f.container === r || f.container === t ? u.width() + u.scrollLeft() : n(f.container).offset().left + n(f.container).width(), e <= n(i).offset().left - f.threshold }; n.abovethetop = function (i, f) { var e; return e = f.container === r || f.container === t ? u.scrollTop() : n(f.container).offset().top, e >= n(i).offset().top + f.threshold + n(i).height() }; n.leftofbegin = function (i, f) { var e; return e = f.container === r || f.container === t ? u.scrollLeft() : n(f.container).offset().left, e >= n(i).offset().left + f.threshold + n(i).width() }; n.inviewport = function (t, i) { return !n.rightoffold(t, i) && !n.leftofbegin(t, i) && !n.belowthefold(t, i) && !n.abovethetop(t, i) }; n.extend(n.expr[":"], { "below-the-fold": function (t) { return n.belowthefold(t, { threshold: 0 }) }, "above-the-top": function (t) { return !n.belowthefold(t, { threshold: 0 }) }, "right-of-screen": function (t) { return n.rightoffold(t, { threshold: 0 }) }, "left-of-screen": function (t) { return !n.rightoffold(t, { threshold: 0 }) }, "in-viewport": function (t) { return n.inviewport(t, { threshold: 0 }) }, "above-the-fold": function (t) { return !n.belowthefold(t, { threshold: 0 }) }, "right-of-fold": function (t) { return n.rightoffold(t, { threshold: 0 }) }, "left-of-fold": function (t) { return !n.rightoffold(t, { threshold: 0 }) } }) })(jQuery, window, document); (typeof console == "undefined" || typeof window.console.log == "undefined") && (window.console = { log: function () { }, info: function () { }, warn: function () { } }); (typeof window.console.group == "undefined" || typeof window.console.groupEnd == "undefined" || typeof window.console.groupCollapsed == "undefined") && (window.console.group = function () { }, window.console.groupEnd = function () { }, window.console.groupCollapsed = function () { }); typeof window.console.markTimeline == "undefined" && (window.console.markTimeline = function () { }); window.console.clear = function () { }; oxygen = {}; window.oxygen = { handler: {} }; EventLogger.prototype.trace = !1; EventLogger.prototype.event = new Event; EventLogger.prototype.eventTarget = ""; EventLogger.prototype.eventTime = ""; EventLogger.create = function (n, t, i, r) { "use strict"; this.event = n; this.target = t; this.control = i; this.comments = r; this.dtm = new Date; EventLogger.trace && console.log("**" + this.event.ename + ":" + this.event.etype + "**\nControl: " + this.control + "\nTarget: " + this.target + "\nComments:\n\t" + this.comments + "\n" + this.dtm.getHours() + ":" + this.dtm.getMinutes() + ":" + this.dtm.getSeconds() + "") }; Event.create = function (n, t) { "use strict"; return this.ename = n, this.etype = t, this }; Log.prototype.add = function (n, t, i, r, u) { "use strict"; this.ename = n; this.etype = t; this.target = i; this.control = r; this.comments = u; var f = new EventLogger.create(new Event.create(n, t), i, r, u) }; log = new Log; oxygen.ready = function () { "use strict"; var c = { ctrl: "body, .oxy-ui" }, v = $(document), y = $(".oxy-ui"), f = { ctrl: ".list-control", collection: ".list__collection", expandList: ".list--expandable", expandTrigger: ".btn--list-expander" }, e = { ctrl: ".drawer-control", clickTrigger: ".drawer__handle", drawerContent: ".drawer__content" }, t = { ctrl: ".i-select-control", slideupClass: ".i-select--slideup", clickTrigger: ".i-select__trigger", triggerLabel: ".i-select__trigger-label", searchWrapper: ".i-select__search", searchInput: ".i-select__input", listControl: ".i-select__list", listCollection: ".i-select__list-collection", listItem: ".list__item", listItemLink: ".list__item-link", selectedVal: ".i-select-selected-val", listItemLabel: ".list__item-label" }, s = { ctrl: ".layout-control", matchHeight: ".layout-control.layout--equal" }, u = { ctrl: ".tab-control", tabBtn: ".tab__btn", tabPanel: ".tab__panel" }, l = $(".switch__item"), i = { ctrl: ".swapper-control", nav: ".swapper__nav", navslider: ".swapper__nav-slider", clickTrigger: ".swapper__btn", contentPnl: ".swapper__pnl", navscroller: ".swapper__nav-scroller", cacheBtn: 0 }, a = $(".input__field"), h = { ctrl: ".input__checkbox-array", label: "label", checkbox: "input[type='checkbox'].input__field" }, o = { ctrl: ".input__radio", label: ".input__radio label", radiobutton: "input[type='radio'].input__field" }, r = { ctrl: ".modal", canvas: ".modal__canvas", canvasCloseOnClick: ".modal__canvas--clickclose", clickTrigger: ".modal__btn--open", closeModalBtn: ".modal__btn--close" }, n; n = { body: function () { $(c.ctrl).on("click", function () { UserAgent() === "IE" && setTimeout(function () { $(".i-select-control").removeClass("control--has-focus").css("z-index", "99") }, 200) }) }, getCollection: function () { }, buttons: function () { $(".button").on("click", function () { }).hover(function () { }, function () { }) }, inputFields: function () { a.focusin(function () { }) }, checkboxes: function () { $(h.checkbox).focusin(function () { $(this).closest(h.label).addClass("focus") }).focusout(function () { $("body").find("label").removeClass("focus") }) }, radiobuttons: function () { $(o.radiobutton).focusin(function () { $(this).closest(o.label).addClass("focus") }).focusout(function () { $(this).closest(o.ctrl).find("label").removeClass("focus") }) }, modals: function () { $(r.clickTrigger).on("click", function (n) { $(r.canvas).fadeIn(400); var t = $(this).attr("data-modalid"); $(t).length > 0; $("#" + t).fadeIn(400).css("top", $("#" + t).offset().top).css("position", "fixed"); $("#" + t).find("a").focus(); n.preventDefault() }); $(r.closeModalBtn).on("click", function (n) { var i = $(this).closest(r.ctrl), t; $(r.canvas).fadeOut(400); $(r.ctrl).fadeOut(400); t = $(i).attr("id"); $("#" + t).css("top", "80px").css("position", "absolute"); $(r.clickTrigger + "[data-modalid='" + t + "']").focus(); n.preventDefault() }); $(r.canvasCloseOnClick).on("click", function (n) { $(r.canvas).fadeOut(400); $(r.ctrl).fadeOut(400); $(r.ctrl).animate({ top: "80px" }, 250).delay(250).css("position", "absolute"); n.preventDefault() }) }, lists: function () { $(f.ctrl).focusin(function () { }); $(f.expandTrigger).on("click", function (n) { var t = $(this).closest(f.expandList); $(t).find(f.collection).css("max-height", "100%"); $(this).hide(); n.preventDefault() }) }, drawerControls: function () { $(e.ctrl).on("click", e.clickTrigger, function (n) { var t = $(this).closest(e.ctrl); $(this).attr("aria-expanded", function (n, t) { return t === "true" ? "false" : "true" }); $(t).find(e.drawerContent).slideToggle(400); $(t).toggleClass("open"); n.stopImmediatePropagation(); n.preventDefault() }) }, selectControls: function () { $(t.ctrl).focusin(function (n) { $(t.ctrl).removeClass("control--has-focus").css("z-index", "99"); var i = $(this).closest(t.ctrl), r = t.listControl; $(i).addClass("control--has-focus"); $(i).find(r).show(); $(i).css("z-index", "100"); n.stopPropagation() }).focusout(function (n) { var i = $(n.target).closest(t.ctrl); $(i).hasClass("control--has-focus") && (UserAgent() === "IE" || setTimeout(function () { $(i).removeClass("control--has-focus").css("z-index", "99") }, 200)); n.stopPropagation() }).on("click", t.clickTrigger, function (n) { var i = $(this).closest(t.ctrl); $(i).hasClass("control--has-focus") || $(i).find(t.searchInput).focus(); n.stopPropagation() }).keydown(function (n) { var r = $(n.target).closest(t.ctrl), f = $(r).find(".list__item.active"), e = $(r).find(t.listCollection), i = 0, o, s, u, h; if (n.which === 27 && $(r).removeClass("control--has-focus").css("z-index", "99"), n.which === 40 && (i = f.index() + 1, i > $(e).find("li").length - 1 && (i = 0)), n.which === 38 && (i = f.index() - 1, i < 0 && (i = $(e).find("li").length - 1)), i >= 0 && (n.which === 40 || n.which === 38)) { $(r).find(".list__item.active").removeClass("active"); u = $(e).find("li:nth-child(" + (i + 1) + ")"); $(u).addClass("active"); $(u).find(t.listItemLink).focus(); s = $(u).find(t.listItemLink).attr("data-idx"); o = $(u).find(t.listItemLink).attr("data-value"); $(r).find(t.triggerLabel).text(o); try { $(this).closest(".i-select-control").find(".i-select__list").scrollTop(48 * s) } catch (c) { } } if ((n.which === 13 || n.which === 32) && $(f).find(t.listItemLink).trigger("click"), h = [33, 34, 35, 36, 37, 38, 39, 40], $.inArray(n.which, h) > -1) return n.preventDefault(), !1; n.stopPropagation(); n.stopImmediatePropagation() }); $(t.listItemLink).on("click", function () { n.selectListItemSelected($(this)) }) }, selectListItemSelected: function (n) { var i = $(n).closest(t.ctrl), u = $(n).attr("data-idx"), r = $(n).attr("data-value"); r = decodeURI(r); $(i).find(t.listItem).removeClass("active"); $(n).parent().addClass("active"); $(i).find(t.triggerLabel).text(r); $(i).find(t.listItemLink).attr("aria-selected", "false"); $(n).attr("aria-selected", "true"); $(i).find(t.selectedVal).val(u); $(i).removeClass("control--has-focus"); $(i).css("z-index", "99") }, layoutControls: function () { n.clearLayoutControls(); $(s.matchHeight).each(function () { var t = 999999999999, i = 0, r = -1; if ($(document).width() > 949) { $(this).find(".layout__panel").each(function (n) { $(this).height() < t && (t = $(this).height(), r = n); $(this).height() > i && (i = $(this).height()) }); var f = $(this).find(".layout__panel").eq(r).find("section:last-child"), u = parseInt(f.innerHeight()), e = u + (i - t); u >= 24 && (console.log("hidx = " + r), console.log("sch = " + u), console.log("nh = " + e), f.css("height", e + "px")) } else n.clearLayoutControls() }) }, clearLayoutControls: function () { $(s.ctrl).find(".layout__panel section").css("height", "auto") }, tabControls: function () { $(u.ctrl).on("click", u.tabBtn, function (n) { var t, i, r; log.add("on", "click", n.target.className, u.ctrl, ""); t = $(this).closest(u.ctrl); $(t).find(u.tabBtn).removeClass("selected").attr("aria-selected", !1); $(t).find(u.tabPanel).removeClass("open").attr("aria-hidden", !0); i = $(this).attr("id") || "noid"; r = i.replace("btn", "pnl"); $(t).find("#" + r).addClass("open").attr("aria-hidden", !1); $(this).addClass("selected").attr("aria-selected", !0); n.preventDefault() }) }, switchEvents: function () { l.on("click", ".switch__btn", function (t) { n.selectedSwitchItem($(this)); t.preventDefault() }).focusin(function (t) { n.selectedSwitchItem(t.target); t.preventDefault() }) }, selectedSwitchItem: function (n) { var i = $(n).attr("id") || "noid", r = i.replace("btn", "pnl"), t = $(n).closest(".switch-control"); $(t).find(".switch__btn").removeClass("selected"); $(n).addClass("selected"); $(t).find(".switch__panel").removeClass("open"); $("#" + r).addClass("open") }, swapperEvents: function () { $(i.clickTrigger).on("click", function (t) { var r = $(t.target).closest(i.ctrl); i.cacheBtn = $(this).parent().children("a").index($(this)); n.selectedSwapperItem($(this)); n.setSwapperNavSliderControl(r); t.preventDefault(); t.stopPropagation() }).keydown(function (n) { var u = $(n.target).closest(i.ctrl), r, t; (n.which === 13 || n.which === 32) && (r = $(n.target).attr("id") || "noid", t = r.replace("btn", "pnl"), $("#" + t).find("a").length > 0 && $("#" + t).find("a")[0].focus()) }).focusin(function (t) { var r = $(t.target).closest(i.ctrl); i.cacheBtn = $(this).parent().children("a").index($(this)); n.selectedSwapperItem(t.target); n.setSwapperNavSliderControl(r); t.preventDefault() }); $(i.ctrl).keydown(function (n) { var t = $(n.target).closest(i.ctrl); n.which === 27 && $(t).find(i.clickTrigger)[i.cacheBtn].focus() }) }, selectedSwapperItem: function (n) { var r = $(n).attr("id") || "noid", u = r.replace("btn", "pnl"), t = $(n).closest(i.ctrl); $(t).find(i.clickTrigger).removeClass("selected"); $(n).addClass("selected"); $(t).find(i.contentPnl).removeClass("open"); $("#" + u).addClass("open") }, setSwapperNavSliderControl: function (n) { var t = i.cacheBtn, r = $(n).find(i.clickTrigger).eq(t).width() + 16, u = $(n).find(i.clickTrigger).eq(t).position().left - 8, f = $(n).find(i.navscroller).scrollLeft(); $(n).find(i.navslider).animate({ left: u + f + "px", width: r + "px" }, 125) } }; $(i.ctrl).each(function () { n.setSwapperNavSliderControl($(this)) }); window.oxygen.handler = n; n.body(); n.buttons(); n.lists(); n.drawerControls(); n.selectControls(); setTimeout(function () { n.layoutControls() }, 50); n.tabControls(); n.switchEvents(); n.swapperEvents(); n.checkboxes(); n.radiobuttons(); n.modals() }; $(document).ready(oxygen.ready); timeout = !1; delta = 200; $(function () { "use strict"; setGridControl(); $(window).resize(function () { rtime = new Date; timeout === !1 && (timeout = !0, setTimeout(resizeend, delta)) }); var n = navigator.userAgent, t = n.match(/iPad/i) ? "touchstart" : "click"; $(".popper__trigger").on(t, function (n) { $(".popper-control .popper-list").stop(!0, !0).slideUp(150); var t = $(this).closest(".popper-control"); $(t).addClass("open").find(".popper-list").slideDown(150); n.preventDefault() }); $(".popper-control.popper--click").focusout(function (n) { $(".popper-control .popper-list").stop(!0, !0).slideUp(350); var t = $(this).closest(".popper-control"); $(t).removeClass("open").find(".popper-list").slideUp(350); n.preventDefault() }); $(".popper-control.popper--hover").hover(function () { $(".popper-control .popper-list").stop(!0, !0).slideUp(150); var n = $(this).closest(".popper-control"); $(n).addClass("open").find(".popper-list").stop(!0, !0).slideDown(350) }, function () { var n = $(this).closest(".popper-control"); $(n).removeClass("open").find(".popper-list").stop(!0, !0).slideUp(350) }) });