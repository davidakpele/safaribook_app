...
<head>
    ...
    <title><?=(isset($data['page_title'])?$data['page_title']. " | " :''). WEBSITE_TITLE;?></title>
	...
	<script src="<?=ASSETS?>js/bootstrap.password.js"></script>
    ...
    <script src="<?=ASSETS?>admin/assets/plugins/summernote/dist/js/summernote.min.js"></script>
    <script src="<?=ASSETS?>admin/assets/plugins/charts-c3/canvasjs.min.js"></script> 
    <script src="<?=ASSETS?>admin/assets/plugins/charts-c3/Chart.min.js"></script>
    <script src="<?=ASSETS?>admin/assets/bower_components/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js"></script>
    <script src="<?=ASSETS?>admin/assets/plugins/sweetalert/sweetalert2@11.js"></script>
    <script>
